...
// //   price: "",
// //   description: "",
// //   image: null,           // ← New file to upload (File | null)
// //   imagePreview: null,    // ← For displaying preview (URL string | null)
// // });
...
// //     imagePreview: item.image || null, // Show existing image
// //   });
// //   setIsEditModalOpen(true);
// // };
...
// //       {/* DELETE MODAL (ORIGINAL UI LOGIC) */}
// //       {isDeleteModalOpen && (
// //         <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
// //           <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 text-center">
// //             <h3 className="text-lg font-bold text-gray-900 mb-2">Delete Item?</h3>
// //             <p className="text-gray-600 text-sm mb-6">Are you sure you want to remove <span className="font-bold text-red-600">{selectedItem?.name}</span>? This action cannot be undone.</p>
// //             <div className="flex gap-3">
// //               <button onClick={() => setIsDeleteModalOpen(false)} className="flex-1 py-2.5 bg-gray-100 rounded-xl font-medium text-gray-700">Cancel</button>
// //               <button onClick={handleDeleteItem} disabled={submitting} className="flex-1 py-2.5 bg-red-600 text-white rounded-xl font-medium">
...
//     imagePreview: null, // URL string for preview
//   });

//   // Clean up blob URLs when closing modals
//   const closeModals = () => {
//     if (formData.imagePreview && formData.imagePreview.startsWith("blob:")) {
//       URL.revokeObjectURL(formData.imagePreview);
//     }
...
//       description: item.description || "",
//       image: null,
//       imagePreview: item.image || null,   // This now correctly shows existing image
//     });
//     setIsEditModalOpen(true);
//   };
...
//       {/* ADD & EDIT MODAL - Original UI Maintained */}
//       {(isAddModalOpen || isEditModalOpen) && (
//         <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
//           <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
//             <div className="px-6 py-4 border-b">
...
//               {/* Image Upload Area - Now correctly shows existing image on edit */}
//               <div className="relative group mt-2">
//                 <div className="w-full h-32 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300 overflow-hidden">
//                   {formData.imagePreview ? (
//                     <img 
...
//                   type="button" 
//                   onClick={closeModals} 
//                   className="px-6 py-2.5 text-gray-700 bg-gray-200 rounded-[11.2px]"
//                 >
//                   Cancel
//                 </button>
//                 <button 
//                   type="submit" 
//                   disabled={submitting} 
//                   className="px-6 py-2.5 bg-[#A61E30] text-white rounded-[11.2px]"
//                 >
//                   {submitting ? "Saving..." : "Save Item"}
//                 </button>
//               </div>
...
//               Are you sure you want to remove <span className="font-bold text-red-600">{selectedItem?.name}</span>? 
//               This action cannot be undone.
//             </p>
//             <div className="flex gap-3">
//               <button 
//                 onClick={() => setIsDeleteModalOpen(false)} 
//                 className="flex-1 py-2.5 bg-gray-100 rounded-xl font-medium text-gray-700"
//               >
//                 Cancel
//               </button>
//               <button 
 ...
 const handleUpdateItem = async (e) => {
  ...
  return (
    <div className="min-h-screen bg-[#f4efe6] p-6 md:p-8 font-sans">
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-sm p-6 text-center max-w-xl">
            <h3 className="text-lg font-bold text-gray-900 mb-2">Delete Item?</h3>
            <p className="text-gray-600 text-sm mb-6">
              Are you sure you want to remove <span className="font-bold text-red-600">{selectedItem?.name}</span>? 
              This action cannot be undone.
